...
- [`full_automation.py`](full_automation.py) - A script that automates everything including getting a task, download the training data, finetune Gemma-2B on training data, merge weights, upload to your HuggingFace model repo, and submit the task to fed-ledger.
